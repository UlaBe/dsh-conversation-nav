...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".convnav-children{margin-left:26px;border-left:2px solid #4a4d55;padding-left:14px}",
