...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".convnav-tick-track{position:absolute;top:0;left:0;right:0;display:flex;flex-direction:column;align-items:center;gap:30.7px;transition:transform 250ms cubic-bezier(.3,.55,.45,1);will-change:transform}",
